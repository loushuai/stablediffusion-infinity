function(token_val, width, height, size, sel_width, sel_height, model_choice, model_path){
    ...
    return [token_val, width, height, size, sel_width, sel_height, model_choice, model_path];
}