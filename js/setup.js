function(token_val, width, height, size, selection_width, selection_height, model_choice, model_path){
    ...
    return [token_val, width, height, size, selection_width, selection_height, model_choice, model_path];
}